...
class DDNetModel(nn.Module):
    ...
    def forward(self, inputs, label_dsp_dim):
        ...
        :return:
        """
        down1 = self.down1(inputs)  # {Tensor:(2,64,200,151)}
        down2 = self.down2(down1)  # {Tensor:(2,128,100,76)}
        down3 = self.down3(down2)  # {Tensor:(2,256,50,38)}
        down4 = self.down4(down3)  # {Tensor:(2,512,25,19)}
        center = self.center(down4)  # {Tensor:(2,1024,25,19)}

        # 25*19*1024
        decoder1_image = center # {Tensor:(2,1024,25,19)}
        decoder2_image = center

        #################
        ###  Decoder1 ###
        #################
        dc1_up4 = self.up4(down4, decoder1_image) # {Tensor:(2,512,50,38)}
        dc1_up3 = self.up3(down3, dc1_up4) # {Tensor:(2,256,100,76)}
        dc1_up2 = self.up2(down2, dc1_up3) # {Tensor:(2,128,200,152)}
        dc1_up1 = self.up1(down1, dc1_up2) # {Tensor:(2,64,400,304)}
        ...
        ###  Decoder2 ###
        #################
        dc2_up4 = self.up4(down4, decoder2_image) # {Tensor:(2,512,50,38)}
        dc2_up3 = self.up3(down3, dc2_up4) # {Tensor:(2,256,100,76)}
        dc2_up2 = self.up2(down2, dc2_up3) # {Tensor:(2,128,200,152)}
        dc2_up1 = self.up1(down1, dc2_up2) # {Tensor:(2,64,400,304)}
